    ...
    <div class="project-info">
      ...
      <div class="icon-views">
        <div class="icon flex flex-col md:flex-row md:space-x-2 justify-between items-center">
          ...
          <a href="https://github.com/malabe-org/backend" target="_blank" class="text-sm md:text-base">Source</a>
        </div>
      </div>
...
The solution presented a web platform and a mobile application.
The team consisted of 4 members: a React developer, an Android developer, a Node js developer (me) and a coordinator who was at the same time the team leader.
        </p>
        <p class="mt-2">
          We designed, coded, tested and presented the solution in less than 3 days. It was a rewarding experience that allowed us to exceed our limits in record time. 
