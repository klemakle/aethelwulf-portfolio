  ...
  <div class="global-project">
    ...
    <div class="rounded-md pt-4 mx:2 md:mx-12 px-2">
      <vueper-slides class="mt-20" fade autoplay bullets-outside :arrows="false"  :slide-ratio="1 / 2" style="z-index:0;">
        <vueper-slide v-for="(slide,i) in transcurePhotos" :image="slide.image" :key="i" />
      </vueper-slides>
    </div>
    <div class="project-info">
      <div class="icon-views">
        <div class="icon flex flex-col md:flex-row md:space-x-2 justify-between items-center">
          ...
          <a href="https://tij.herokuapp.com/" target="_blank" class="text-sm md:text-base">Test website</a>
        </div>
      </div>
      <div class="description">
        <div class="role text-sm md:text-lg"> 
          <span class="tech-text text-white">Roles</span>&nbsp; {{'< Fullstack developer/>'}} 
        </div>
        <div class="bref-desc">
          <p> TransCure bioServices is a unique fee-for-service CRO (Contract Research Organization), with an expertise in conducting research using humanized mouse models.</p>
          <p class="mt-2">The project consists of a web application for visualizing data from an Excel file. The data are recordings of mouse tumors.</p>
...
import {transcure} from '~/assets/js/photo.js';
