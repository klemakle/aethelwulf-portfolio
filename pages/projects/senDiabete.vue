<template>
  <div class="global-project">
    ...
    <div class="rounded-md mt-4 mx:2 md:mx-12">
      <vueper-slides fade autoplay pause-on-hover bullets-outside :arrows="false"  :slide-ratio="1 / 2">
    ...
    <div class="project-info">
      ...
      <div class="icon-views">
        <div class="icon flex flex-col justify-between items-center">
          ...
          <a href="https://sen-diabete-web.herokuapp.com/" target="_blank" class="text-sm md:text-base">Test website</a>
        </div>
      </div>
      <div class="description">
        <div class="role text-sm md:text-lg"> 
          <span class="tech-text text-white">Roles</span>&nbsp; < Frontend developer/> 
        </div>
        <div class="bref-desc">
          <p> Sen Diabete is a web application that connects diabetes patients with doctors.  This in order to control the variations of the glycemia remotely.</p>
          <p class="mt-2">The project consists of a web application for doctors and nurses and a mobile application for patients.
The web app was made with angular 11 and the mobile app with ionic</p>
        <p class="mt-2">
          I was the front-end developer of this web application. I also participated in the implementation of some APIs with express
        </p>
        <!-- <p>
          We designed, coded, tested and presented the solution in less than 5 days. It was a rewarding experience that allowed us to exceed our limits in record time. 
          I had made over 46 commits in less than 48 hours.
        </p>
        <p>
          You will see above the demo of the web application and the source code of the backend.
        </p> -->
...
import {sendiabete} from '~/assets/js/photo.js';
