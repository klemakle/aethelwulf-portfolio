<template>
    <div class="container py-24">
        ...
        <div class="flex flex-col gap-x-12 gap-y-10 md:flex-row flex-wrap justify-center items-center">
            ...
            <nuxt-link to="/blog/sql-injection-classic" class="blog-card border-1 border-gray-400 rounded-md bg-slate-100 hover:bg-slate-200 md:w-2/5 h-max py-10 px-4">
            ...
            <nuxt-link to="/blog/sql-blind-injection" class="blog-card border-1 border-gray-400 rounded-md bg-slate-100 hover:bg-slate-200 md:w-2/5 h-max py-10 px-4">
                <div class="blog-title text-black font-bold mb-2">
