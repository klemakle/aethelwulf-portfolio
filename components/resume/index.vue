<template>
  <div class="global-resume mt-20">
    <div class="resume-page">
      ...
      <a href="https://drive.google.com/file/d/1IVjiYZHTgFnho-ziNBpr0N73jdrvFWDP/view?usp=sharing" target="_blank" class="my-resume mt-4 pointer self-start">
...
import ExperiencePro from './experiencePro.vue';
import ExperienceSocial from './experienceSocial.vue';
export default {
  components:{
    Formation,
    ExperiencePro,
